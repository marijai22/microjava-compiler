...
public class SemAnalyser extends VisitorAdaptor {
	...
	private HashSet<String> gotoLabels = null;
	...
	public void visit(MethodDecl methodDecl) {
		...
		if(!declaredLabels.containsAll(gotoLabels))
			report_error("Goto statement skace na nepostojecu labelu: " + currMethod.getName(), methodDecl);
